...
class Translator implements TranslatorInterface
{
    ...
    {
        return $this->transChoice($id, 1, $parameters, $domain, $locale);
    }
     ...
     * @api
     */
    public function transplural($id, array $parameters = array(), $domain = null, $locale = null)
    {
        return $this->transChoice($id, 2, $parameters, $domain, $locale);
    }
